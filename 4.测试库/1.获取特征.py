...
app.prepare(ctx_id=0, det_thresh=0.1)  # ctx_id=-1 for CPU, 0 for GPU
...
def get_face_embedding2(image_path):
    """Extract face embedding from an image"""
...
image1_path = "../data/lfw_funneled/John_Paul_II/John_Paul_II_0004.jpg"
image2_path = "./error_image/Angela_Bassett-Angela_Bassett_0004.jpg"
try:
    # Get embeddings
    emb1 = get_face_embedding(image1_path)
    emb2 = get_face_embedding(image2_path)
    # a = get_face_embedding2([image1_path,image2_path])
    # Compare faces
