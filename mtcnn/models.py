...
class RNet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = np.load(os.path.join('/Users/zkj/PycharmProjects/InsightFace', 'mtcnn/weights/rnet.npy'), allow_pickle=True)[()]
...
class ONet(nn.Module):
    ...
    def __init__(self):
        ...
        weights = np.load(os.path.join('/Users/zkj/PycharmProjects/InsightFace', 'mtcnn/weights/onet.npy'), allow_pickle=True)[()]
